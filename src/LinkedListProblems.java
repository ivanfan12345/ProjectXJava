...
public class LinkedListProblems {
    ...
    public LinkedListNode reverseLinkedListRecursive(LinkedListNode node , LinkedListNode prev)
    {
        if(node == null) return null;
        if(node.next == null)
        {
        ...
        LinkedListNode reversedPart = reverseLinkedListRecursive(node.next , node);
